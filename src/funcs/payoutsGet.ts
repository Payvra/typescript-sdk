...
export function payoutsGet(
  ...
  Result<
    operations.PayoutsGetByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PayoutsGetByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/payouts/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PayoutsGetByIdResponse$inboundSchema),
