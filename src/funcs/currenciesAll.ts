...
export function currenciesAll(
  ...
  Result<
    Array<operations.CurrenciesGetAllResponse>,
...
> {
  const path = pathToFunc("/v1/currencies")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(operations.CurrenciesGetAllResponse$inboundSchema)),
