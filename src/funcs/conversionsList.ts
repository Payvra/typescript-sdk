...
export function conversionsList(
  ...
  Result<
    operations.ConversionsListOwnedResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConversionsListOwnedRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/conversions/list")();
  ...
  const context = {
    ...
    operationID: "conversions-listOwned",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConversionsListOwnedResponse$inboundSchema),
