...
export function payoutsCreate(
  ...
  Result<
    operations.PayoutsCreateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PayoutsCreateRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/payouts")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PayoutsCreateResponse$inboundSchema),
