 ...
 */
export function walletsListOwned(
  client: PayvraCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.WalletsGetAllOwnedResponse>,
...
> {
  const path = pathToFunc("/v1/wallets")();
  ...
  const context = {
    ...
    operationID: "wallets-getAllOwned",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(operations.WalletsGetAllOwnedResponse$inboundSchema)),
