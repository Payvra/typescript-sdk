...
export function walletsStats(
  ...
  Result<
    operations.WalletsGetStatsResponse,
...
> {
  const path = pathToFunc("/v1/wallets/stats")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WalletsGetStatsResponse$inboundSchema),
