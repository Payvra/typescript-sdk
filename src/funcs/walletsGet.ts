...
export function walletsGet(
  ...
  Result<
    operations.WalletsGetByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.WalletsGetByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/wallets/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WalletsGetByIdResponse$inboundSchema),
