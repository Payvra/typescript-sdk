 ...
 */
export function paymentInvoicesStats(
  client: PayvraCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PaymentInvoicesGetStatsResponse,
...
> {
  const path = pathToFunc("/v1/payment-invoices/stats")();
  ...
  const context = {
    ...
    operationID: "paymentInvoices-getStats",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PaymentInvoicesGetStatsResponse$inboundSchema),
