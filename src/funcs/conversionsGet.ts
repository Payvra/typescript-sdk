...
export function conversionsGet(
  ...
  Result<
    operations.ConversionsGetByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ConversionsGetByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/conversions/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConversionsGetByIdResponse$inboundSchema),
