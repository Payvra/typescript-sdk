 ...
 */
export function conversionsCreate(
  client: PayvraCore,
  request: operations.ConversionsCreateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ConversionsCreateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ConversionsCreateRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/conversions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConversionsCreateResponse$inboundSchema),
