...
export function payoutsStats(
  ...
  Result<
    operations.PayoutsGetStatsResponse,
...
> {
  const path = pathToFunc("/v1/payouts/stats")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PayoutsGetStatsResponse$inboundSchema),
